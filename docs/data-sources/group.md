...
page_title: "windowsad_group Data Source - terraform-provider-windowsad"
subcategory: ""
description: |-
  Get the details of an Active Directory Group object.
---

# windowsad_group (Data Source)
...
output "groupname" {
    value = data.windowsad_group.g.name
}
...
output "g2_guid" {
    value = data.windowsad_group.g2.id
}

output "g2_description" {
    value = data.windowsad_group.g2.description
}
```
