...
page_title: "windowsad_user Data Source - terraform-provider-windowsad"
subcategory: ""
description: |-
  Get the details of an Active Directory user object.
---

# windowsad_user (Data Source)
...
output "username" {
    value = data.windowsad_user.u.sam_account_name
}

output "country" {
    value = data.windowsad_user.u.country
}

output "trusted_for_delegation" {
    value = data.windowsad_user.u.trusted_for_delegation
}
...
output "testuser_guid" {
    value = data.windowsad_user.u2.id
}
```
