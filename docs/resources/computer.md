...
page_title: "windowsad_computer Resource - terraform-provider-windowsad"
subcategory: ""
description: |-
  windowsad_computer manages computer objects in an AD tree.
---

# windowsad_computer (Resource)
