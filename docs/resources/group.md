...
page_title: "windowsad_group Resource - terraform-provider-windowsad"
subcategory: ""
description: |-
  windowsad_group manages Group objects in an Active Directory tree.
---

# windowsad_group (Resource)
