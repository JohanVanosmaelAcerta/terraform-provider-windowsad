...
page_title: "windowswindowsad_group_membership Resource - terraform-provider-windowsad"
subcategory: ""
description: |-
  windowswindowsad_group_membership manages the members of a given Active Directory group.
---

# windowswindowsad_group_membership (Resource)
...
resource "windowswindowsad_group" "g" {
  name             = var.name
...
resource windowswindowsad_group "g2" {
    name             = "${var.name}-2"
...
resource windowswindowsad_user "u" {
...
resource windowswindowsad_group_membership "gm" {
    group_id = windowswindowsad_group.g.id
    group_members  = [ windowswindowsad_group.g2.id, windowswindowsad_user.u.id ]
}
```
...
# by a slash `/`.
$ terraform import windowswindowsad_group_membership 9CB8219C-31FF-4A85-A7A3-9BCBB6A41D02/E9079B50-95C5-4101-8400-E01CC83CF53B
```
